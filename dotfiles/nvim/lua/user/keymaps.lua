...
-- Harpoon keymaps
nnoremap("<leader>ho", function() harpoon.ui:toggle_quick_menu(harpoon:list()) end)
nnoremap("<leader>ha", function() harpoon:list():append() end)
nnoremap("<leader>h1", function() harpoon:list():select(1) end)
nnoremap("<leader>h2", function() harpoon:list():select(2) end)
nnoremap("<leader>h3", function() harpoon:list():select(3) end)
nnoremap("<leader>h4", function() harpoon:list():select(4) end)
